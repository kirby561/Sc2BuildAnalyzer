...
Sc2Unit Sc2Unit::Units[] = {
	// Terran Units
	new Sc2Unit(Scv, "SCV", 12, 50, 0, 1),
	new Sc2Unit(Marine, "Marine", 12, 50, 0, 1),
	new Sc2Unit(Reaper, "Reaper", 32, 50, 50, 1),
	new Sc2Unit(Marauder, "Marauder", 21, 100, 25, 2),
	new Sc2Unit(Ghost, "Ghost", 29, 200, 100, 2),
	new Sc2Unit(Hellion, "Hellion", 21, 100, 0, 2),
	new Sc2Unit(WidowMine, "WidowMine", 21, 75, 25, 2),
	new Sc2Unit(Cyclone, "Cyclone", 32, 150, 100, 3),
	new Sc2Unit(Tank, "Tank", 32, 150, 125, 3),
	new Sc2Unit(Thor, "Thor", 43, 300, 200, 6),
	new Sc2Unit(Viking, "VikingFighter", 30, 150, 75, 2),
	new Sc2Unit(Medivac, "Medivac", 30, 100, 100, 2),
	new Sc2Unit(Liberator, "Liberator", 43, 150, 100, 3),
	new Sc2Unit(Raven, "Raven", 43, 100, 200, 2),
	new Sc2Unit(Banshee, "Banshee", 43, 150, 100, 3),
	new Sc2Unit(BattleCruiser, "Battlecruiser", 64, 400, 300, 6),
	new Sc2Unit(Nuke, "Nuke", 43, 100, 100, 0),
	
	// Terran Buildings
	new Sc2Unit(SupplyDepot, "SupplyDepot", 21, 100, true),
	...
	new Sc2Unit(EngineeringBay, "EngineeringBay", 25, 125, 0),
	...
	// Protoss Units // ?? TODO: Add warp in time separately.
	new Sc2Unit(Probe, "Probe", 12, 50, 0, 1),
	new Sc2Unit(Zealot, "Zealot", 27, 100, 0, 2),
	new Sc2Unit(Adept, "Adept", 27, 100, 25, 2),
	new Sc2Unit(Stalker, "Stalker", 30, 125, 50, 2),
	new Sc2Unit(Sentry, "Sentry", 26, 50, 100, 2),
	new Sc2Unit(HighTemplar, "HighTemplar", 39, 50, 150, 2),
	new Sc2Unit(DarkTemplar, "DarkTemplar", 39, 125, 125, 2),
	new Sc2Unit(Archon, "Archon", 9, 0, 0, 4),
	new Sc2Unit(Observer, "Observer", 21, 25, 75, 1),
	new Sc2Unit(Immortal, "Immortal", 39, 250, 100, 4),
	new Sc2Unit(Colossus, "Colossus", 54, 300, 200, 6),
	new Sc2Unit(WarpPrism, "WarpPrism", 36, 200, 0, 2),
	new Sc2Unit(Disruptor, "Disruptor", 36, 150, 150, 3),
	new Sc2Unit(Phoenix, "Phoenix", 25, 150, 100, 2),
	new Sc2Unit(Oracle, "Oracle", 37, 150, 150, 3),
	new Sc2Unit(VoidRay, "VoidRay", 43, 250, 150, 4),
	new Sc2Unit(Carrier, "Carrier", 86, 350, 250, 6),
	new Sc2Unit(Tempest, "Tempest", 43, 300, 200, 6),
	new Sc2Unit(MothershipCore, "MothershipCore", 21, 100, 100, 2),
	new Sc2Unit(Mothership, "Mothership", 114, 400, 400, 8),
	...
	new Sc2Unit(Queen, "Queen", 36, 150, 0, 2),
	new Sc2Unit(Zergling, "Zergling", 17, 50, 0, 1),
	new Sc2Unit(Baneling, "Baneling", 14, 25, 25, 0.5f),
	new Sc2Unit(Roach, "Roach", 19, 75, 25, 2),
	new Sc2Unit(Ravager, "Ravager", 9, 25, 75, 3),
	new Sc2Unit(Hydralisk, "Hydralisk", 24, 100, 50, 2),
	new Sc2Unit(Lurker, "Lurker", 18, 50, 100, 3),
	new Sc2Unit(Infestor, "Infestor", 36, 100, 150, 2),
	new Sc2Unit(SwarmHost, "SwarmHost", 29, 100, 75, 3),
	new Sc2Unit(Overlord, "Overlord", 18, 100, 0, 0),
	new Sc2Unit(Overseer, "Overseer", 12, 50, 50, 0),
	new Sc2Unit(Mutalisk, "Mutalisk", 24, 100, 100, 2),
	new Sc2Unit(Corruptor, "Corruptor", 29, 150, 100, 2),
	new Sc2Unit(BroodLord, "BroodLord", 24, 150, 150, 4),
	new Sc2Unit(Viper, "Viper", 29, 100, 200, 3),
	new Sc2Unit(Ultralisk, "Ultralisk", 39, 300, 200, 6),
...
Sc2Unit::Sc2Unit(UnitId unitId, QString unitName, int buildTimeSecs, int mineralCost, int gasCost, float supplyCost)
	: Sc2Unit(unitId, unitName, buildTimeSecs, mineralCost, gasCost, supplyCost) {
}
